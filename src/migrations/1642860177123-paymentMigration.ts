...
export class paymentMigration1642860177123 implements MigrationInterface {
    name = "paymentMigration1642860177123"
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query("CREATE TABLE \"bookings\" (\"id\" SERIAL NOT NULL, \"roomNumber\" integer NOT NULL, \"isTaken\" boolean NOT NULL DEFAULT false, \"hotelId\" integer, \"userId\" integer, CONSTRAINT \"REL_38a69a58a323647f2e75eb994d\" UNIQUE (\"userId\"), CONSTRAINT \"PK_bee6805982cc1e248e94ce94957\" PRIMARY KEY (\"id\"))");
      await queryRunner.query("CREATE TABLE \"payments\" (\"id\" SERIAL NOT NULL, \"ticket\" character varying NOT NULL, \"hotel\" boolean NOT NULL, \"value\" integer NOT NULL, \"userId\" integer NOT NULL, CONSTRAINT \"PK_197ab7af18c93fbb0c9b28b4a59\" PRIMARY KEY (\"id\"))");
