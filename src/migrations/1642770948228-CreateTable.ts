...
export class CreateTable1642770948228 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payments" ("id" SERIAL NOT NULL, "hotel" boolean NOT NULL, "ticket" character varying NOT NULL, "value" integer NOT NULL, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
