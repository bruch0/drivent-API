...
export class CreateTable1642965789348 implements MigrationInterface {
  name = "CreateTable1642965789348";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payments" ("id" SERIAL NOT NULL, "hotel" boolean NOT NULL DEFAULT false, "ticket" character varying NOT NULL, "value" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
